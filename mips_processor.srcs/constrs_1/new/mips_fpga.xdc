...
set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS33} [get_ports {sel}];   # Switch 4

# LEDs
set_property -dict {PACKAGE_PIN L1 IOSTANDARD LVCMOS33} [get_ports {dispSe}]; 
set_property -dict {PACKAGE_PIN P1 IOSTANDARD LVCMOS33} [get_ports {factErr}];
set_property -dict {PACKAGE_PIN N3 IOSTANDARD LVCMOS33} [get_ports {factErr}];  
set_property -dict {PACKAGE_PIN P3 IOSTANDARD LVCMOS33} [get_ports {factErr}];  
set_property -dict {PACKAGE_PIN U3 IOSTANDARD LVCMOS33} [get_ports {factErr}];
